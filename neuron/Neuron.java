...
/**
 * The Neuron class is the simplest neuron available. It contains an 
 ...
 * it through its ActivationFunction. The Neuron also needs to be able to
 ...
 * 
 * To create a Neuron, we only need specify how many weights it should have. 
...
public class Neuron {
   ...
   /** 
    * The ActivationFunction for this particular Neuron.
    */
   ...
   /**
    * the updateWeights method adds a multiple of the gradient vector
    * to each of the weights in the weights array.
    * @param scaledGradient the gradient vector, scaled by the learning rate.
    */
   public void updateWeights(double[] scaledGradient) {
      for (int i = 0; i < this.weights.length; i++) {
         this.weights[i] += scaledGradient[i];
      }
   }
